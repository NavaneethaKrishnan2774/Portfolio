...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    console.log("Service:", "service_706ln5c");
    console.log("Template:", "template_j33uweo");
    console.log("Public Key:", "sX510AorpTRgAuBBt");
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <span>naveenmd2004@gmail.com</span>
              </div>

              <div className="flex items-center gap-4">
                <FaPhoneAlt className="text-green-400 text-2xl" />
                <span>+91 9751271458</span>
              </div>
            </div>
